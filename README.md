...
- **Geolocation**: MapKit, CoreLocation
- **Media**: AVFoundation, FileManager
- **Tests**: XCTest
- **Cloud Services**: Firebase
- **Principles**: SOLID, DRY, KISS, YAGNI
- **Patterns**: Dependency Injection, Delegation
- **Managers**: SwiftPackageManager, CocoaPods
...
- ✉️ Email: [ArsentyHalimovsky@yandex.ru](mailto:ArsentyHalimovsky@yandex.ru)
- 💬 Telegram [Link](https://t.me/Hieronius)
- 💼 Linkedin [Link](http://www.linkedin.com/in/hieronius)
